...
FightClass.create(type_of_fight: "Krav Maga", instructor_id: 1, start_time: Time.parse("8:00 PM"), end_time: Time.parse("8:45 PM"))
FightClass.create(type_of_fight: "Taekwondo", instructor_id: 2, start_time: Time.parse("6:00 PM"), end_time: Time.parse("7:45 PM"))
FightClass.create(type_of_fight: "Krav Maga", instructor_id: 3, start_time: Time.parse("8:00 PM"), end_time: Time.parse("8:45 PM"))
FightClass.create(type_of_fight: "Kungfu", instructor_id: 1, start_time: Time.parse("5:00 PM"), end_time: Time.parse("6:45 PM"))
FightClass.create(type_of_fight: "Kungfu", instructor_id: 4, start_time: Time.parse("6:00 PM"), end_time: Time.parse("6:45 PM"))
FightClass.create(type_of_fight: "Taekwondo", instructor_id: 5, start_time: Time.parse("7:00 PM"), end_time: Time.parse("8:45 PM"))
